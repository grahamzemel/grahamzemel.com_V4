...
{#if showModal}
  <div
    class="fixed inset-0 z-10 bg-secondary-700/30"
  ...
  >
    <div
      class="mx-auto overflow-x-hidden rounded-lg bg-[#101010] shadow-xl w-full h-full md:max-w-[85vw] md:max-h-[85vh]"
    >
      <div class="relative p-6">
        ...
        <div class="flex justify-center">
          <iframe
            title="Cal.com"
            class="mt-6 mb-3 w-full max-w-[95vw] md:max-w-[80vw] h-[800px] overflow-auto"
            src="https://app.cal.com/grahamzemel/quick-chat"
            frameborder="0"
          />
        </div>
      </div>
